...
/**
 * 机器人功能列表 TgBofeaturesExample
 * @author fuce_自动生成
 * @date 2021-02-09 19:30:33
 */
public class TgBofeaturesVo {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andDepIdNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(TgBofeatures record) {
			...
			if(record.getService()!=null&&StrUtil.isNotEmpty(record.getService().toString())) {
    			 list.add("ifnull(service,'')");
    		}
			if(record.getConfig()!=null&&StrUtil.isNotEmpty(record.getConfig().toString())) {
    			 list.add("ifnull(config,'')");
    		}
			...
			if(record.getService()!=null&&StrUtil.isNotEmpty(record.getService().toString())) {
    			list2.add("'%"+record.getService()+"%'");
    		}
			if(record.getConfig()!=null&&StrUtil.isNotEmpty(record.getConfig().toString())) {
    			list2.add("'%"+record.getConfig()+"%'");
    		}
			if(record.getDepId()!=null&&StrUtil.isNotEmpty(record.getDepId().toString())) {
