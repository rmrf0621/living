...
public class CompanyJobVo implements Serializable {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andStateNotBetween(String value1, String value2) {
		 ...
		 public Criteria andLikeQuery(CompanyJob record) {
			...
			if(record.getCompany()!=null&&StrUtil.isNotEmpty(record.getCompany().toString())) {
    			 list.add("ifnull(company,'')");
    		}
			if(record.getWelfare()!=null&&StrUtil.isNotEmpty(record.getWelfare().toString())) {
    			 list.add("ifnull(welfare,'')");
    		}
			if(record.getJobs()!=null&&StrUtil.isNotEmpty(record.getJobs().toString())) {
    			 list.add("ifnull(jobs,'')");
    		}
			...
			if(record.getCompany()!=null&&StrUtil.isNotEmpty(record.getCompany().toString())) {
    			list2.add("'%"+record.getCompany()+"%'");
    		}
			if(record.getWelfare()!=null&&StrUtil.isNotEmpty(record.getWelfare().toString())) {
    			list2.add("'%"+record.getWelfare()+"%'");
    		}
			if(record.getJobs()!=null&&StrUtil.isNotEmpty(record.getJobs().toString())) {
    			list2.add("'%"+record.getJobs()+"%'");
    		}
			if(record.getPosition()!=null&&StrUtil.isNotEmpty(record.getPosition().toString())) {
