 ...
 * tg群组 TgGroupExample
 * @author fuce_自动生成
 * @date 2021-02-07 19:50:19
 */
public class TgGroupVo {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andStateNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(TgGroup record) {
			...
			if(record.getGroupName()!=null&&StrUtil.isNotEmpty(record.getGroupName().toString())) {
    			 list.add("ifnull(group_name,'')");
    		}
			...
			if(record.getClasses()!=null&&StrUtil.isNotEmpty(record.getClasses().toString())) {
    			 list.add("ifnull(classes,'')");
    		}
			if(record.getGroupDesc()!=null&&StrUtil.isNotEmpty(record.getGroupDesc().toString())) {
    			 list.add("ifnull(group_desc,'')");
    		}
			...
			if(record.getClasses()!=null&&StrUtil.isNotEmpty(record.getClasses().toString())) {
    			list2.add("'%"+record.getClasses()+"%'");
    		}
			if(record.getGroupDesc()!=null&&StrUtil.isNotEmpty(record.getGroupDesc().toString())) {
    			list2.add("'%"+record.getGroupDesc()+"%'");
    		}
			if(record.getState()!=null&&StrUtil.isNotEmpty(record.getState().toString())) {
